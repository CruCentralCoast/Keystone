...
Event.add({
  ...
  startDate: { type: Types.Datetime, format: 'YYYY MMM Do hh:mm a', default: Date.now(), required: true, initial: true },
  endDate: { type: Types.Datetime, format: 'YYYY MMM Do hh:mm a', default: Date.now(), required: true, initial: true },
