...
PrayerRequest.add({
    ...
    genderPreference: { type: Types.Select, options: [ { value: 1, label: 'Male' }, { value: 2, label: 'Female' }, { value: 9, label: 'Not Applicable' } ], initial: true, dependsOn: { leadersOnly: [true] } },
