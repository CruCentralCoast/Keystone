...
Resource.add({
  ...
  restricted: { type: Types.Boolean, note: "Whether the resource should be restricted to leaders only.", initial: true },
  author: { type: Types.Text, initial: true, required: false},
